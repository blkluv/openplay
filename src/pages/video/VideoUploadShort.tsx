...
export default function VideoUploadShort() {
  useSeoMeta({
    title: 'Upload Short - OpenPlay',
    description: 'Upload your short vertical video to the decentralized network',
  });
  ...
  const [selectedServer, setSelectedServer] = useState('primal');
            ...
            <Alert className="mb-6">
              ...
              <AlertDescription className="mt-2 space-y-2">
                ...
                <p className="text-sm mt-2">
                  <strong>Important:</strong> Uploads may fail or time out without a paid subscription.
